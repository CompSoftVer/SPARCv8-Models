...
definition get_nat_from_mask::"32 word \<Rightarrow> nat \<Rightarrow> nat \<Rightarrow> (32 word \<times> nat)" 
where
"
...
definition get_nat_from_mask32::"32 word \<Rightarrow> nat"
where
"get_nat_from_mask32 w \<equiv> 
                            if (w=0) then len_of TYPE (32)
                            else
