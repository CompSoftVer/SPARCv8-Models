...
\<comment>\<open>chapter "Deterministic State Monad with Failure"\<close>
...
\<comment>\<open>lemma returnOk_bindE [simp]: "(returnOk x >>=E f) = f x"
...
\<comment>\<open>lemma "doE x \<leftarrow> returnOk 1; 
           returnOk 2; 
           returnOk x 
       odE = returnOk 1" 
  by simp\<close>
